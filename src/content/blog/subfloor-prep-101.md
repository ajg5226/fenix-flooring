---
title: Subfloor Prep 101 — The Step That Makes or Breaks Commercial Floors
description: "Commercial subfloor prep explained for SE PA—flatness, moisture testing, leveling/patching, and what to specify so LVT and carpet tile don’t fail early on."
pubDate: 2025-07-22
draft: false
image: /images/pc4.webp
imageAlt: "Concrete subfloor preparation in progress"
tags:
  - subfloor-prep
  - moisture-mitigation
...
![Concrete subfloor preparation in progress](/images/pc4.webp)
...
| Finish floor type | Prep sensitivity | Most common failure when prep is weak | What to focus on |
|---|---|---|---|
| LVT/LVP (commercial) | High | Telegraphing, loose spots, gapping | Flatness, skim/patch quality, moisture plan |
| Carpet tile | Medium | Premature wear in dips, adhesive issues in weak zones | Smooth transitions, substrate soundness, moisture awareness |
| Tile/porcelain | High (especially large-format) | Lippage, cracked grout/tile | Flatness, substrate stability, joint/crack plan |
...
- Commercial Flooring Types Explained: LVT/LVP vs Carpet Tile vs Tile vs Epoxy — anchor: commercial flooring types
- Moisture Mitigation for Concrete Slabs: What Property Managers Need to Know — anchor: moisture mitigation for concrete slabs
- Commercial LVT/LVP Buyer’s Guide: Wear Layer, WPC/SPC, Glue-Down vs Click — anchor: subfloor prep for lvt
- Flooring Mistakes That Cost You: 12 Failure Modes and How to Prevent Them — anchor: flooring failures from poor prep
- Installation Phasing Plan: How to Replace Flooring Without Shutting Down the Business — anchor: installation phasing plan
- RFP / Scope of Work Template: How to Get Comparable Quotes From Flooring Contractors — anchor: scope of work template
...
```json
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What does “flat” mean for commercial floors?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Flat means the surface is even enough for the flooring to install without rocking, gaps, or stress points. It’s different from “level,” which is about horizontal slope. Most problems show up because floors aren’t flat where it counts."
      }
    },
    {
      "@type": "Question",
      "name": "Do I need moisture testing for every concrete slab?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Often, yes—especially when installing LVT or when the building is older, below grade, or has a leak history. Moisture conditions can vary across the same slab, so testing helps you avoid surprise failures and change orders."
      }
    },
    {
      "@type": "Question",
      "name": "Can you install LVT over existing VCT or tile?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sometimes, but it depends on bond, flatness, and the condition of the existing floor. The biggest risk is telegraphing (seeing old seams or texture through the new LVT) and adhesive compatibility. A site walk is the right place to decide."
      }
    },
    {
      "@type": "Question",
      "name": "Why do seams and joints “telegraph” through LVT?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "LVT is thin and follows the shape of what’s underneath. Any ridge, seam, patch edge, or texture can show through under normal lighting. Skim coating and proper patching are often what prevent this."
      }
    },
    {
      "@type": "Question",
      "name": "How long do leveling compounds take to cure?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It depends on the product, thickness, and jobsite conditions. Some patches are ready quickly, while thicker leveling work needs more time—especially if the space isn’t conditioned. Cure time should be built into the schedule, not “hoped for.”"
      }
    },
    {
      "@type": "Question",
      "name": "When is moisture mitigation actually required?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "When the slab’s moisture condition is outside what the chosen flooring system can tolerate, mitigation becomes the practical fix. It’s also common when you can’t risk downtime and need a predictable, warrantable system for a sensitive floor type like LVT."
      }
    },
    {
      "@type": "Question",
      "name": "What should I include in a subfloor prep line item on a quote?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You want a defined flatness target, a clear prep method (patch vs skim vs leveling), a moisture testing plan on slabs, and a path for what happens if conditions are worse after demo. If those pieces aren’t spelled out, the quote usually isn’t comparable."
      }
    }
  ]
}
