...
export const navigation = {
  ...
  areas: [
    { name: 'Philadelphia, PA', href: '/areas/philadelphia/' },
    { name: 'Wilmington, DE', href: '/areas/wilmington/' },
    { name: 'Allentown, PA', href: '/areas/allentown/' },
    { name: 'Lancaster, PA', href: '/areas/lancaster/' },
    { name: 'Reading, PA', href: '/areas/reading/' },
    { name: 'West Chester, PA', href: '/areas/west-chester/' },
    { name: 'King of Prussia, PA', href: '/areas/king-of-prussia/' },
    { name: 'Harrisburg, PA', href: '/areas/harrisburg/' },
    { name: 'Dover, DE', href: '/areas/dover/' },
    { name: 'Westchester County, NY', href: '/areas/westchester-county-ny/' },
    { name: 'York, PA', href: '/areas/york/' },
  ],
  footer: [
